#!/usr/bin/env Rscript
source("inflplot.r")
seasonlab <- "säsong (juli år X till juni år X+1, data för 2024 preliminära)"
...
ggsave("../../images/covpop_2019-2023.svg")
infl085_sum_fy_pop |> inflplot("1996-02-01", "influensa", seasonlab, "incidens")
ggsave("../../images/inflpop_1998-2023.svg")
...
ggsave("../../images/covnorm_2019-2023.svg")
