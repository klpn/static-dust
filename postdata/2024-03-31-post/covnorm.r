...
cov085_sum_fy_pop |>
    inflplot("2018-02-01", "covid-19", "säsong  (juli år X till juni år X+1, 2023 preliminärt till december)",
             "incidens")
ggsave("../../images/covpop.svg")
infl085_sum_fy_pop |>
    inflplot("1996-02-01", "influensa", "säsong  (juli år X till juni år X+1, 2023 preliminärt till december)",
             "incidens")
ggsave("../../images/inflpop.svg")
inflfnorm(cov085_sum_fy_pop, inflfmgrp(infl085_sum_fy_pop, max), c("Sex", "sage")) |>
    inflplot("2018-01-01", "covid-19", "säsong  (juli år X till juni år X+1, 2023 preliminärt till december)",
